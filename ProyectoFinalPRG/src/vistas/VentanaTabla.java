...
import controlador.utils.views.GestionCeldas;
import controlador.utils.views.GestionEncabezadoTabla;
import controlador.utils.views.ModeloTabla;
...
public class VentanaTabla extends JFrame implements MouseListener{
	...
	private ArrayList<PersonaVo> consultarListaPersonas() {
		...
		lista.add(new PersonaVo(" ", "  ", " ", " ", " ",23, 2.5, 4.3, 3.0, (2.5+4.3+3)/33));
		lista.add(new PersonaVo(" ", "  ", " ", " ", " ",0, 0, 0,0,0));
		lista.add(new PersonaVo(" ", " ", " ", " ", " ",0, 0, 0,0,0));
		lista.add(new PersonaVo(" ", " ", " ", " ", " ",0, 0, 0,0,0));
		lista.add(new PersonaVo(" ", " ", " ", " ", " ",0, 0, 0,0,0));
		lista.add(new PersonaVo(" ", " ", " ", " ", " ",0, 0, 0,0,0));
