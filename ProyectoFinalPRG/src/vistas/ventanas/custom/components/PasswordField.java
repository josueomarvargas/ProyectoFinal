package vistas.ventanas.custom.components;
...
public class PasswordField extends JPasswordField {
	...
	public PasswordField() {
		...
		eye = new ImageIcon(getClass().getResource("/vistas/ventanas/custom/components/img/eye.png")).getImage();
		eye_hide = new ImageIcon(getClass().getResource("/vistas/ventanas/custom/components/img/eye_hide.png"))
				.getImage();
